                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="uid" class="form-control @if($errors->has('uid')) is-invalid @endif" id="uid" value="{{ old('uid') }}" placeholder="{{ __('words.LoginId') }}" autofocus @if($errors->has('uid')) aria-describedby="uid-error" aria-invalid="true" @endif>
                            @if($errors->has('uid'))
