...
class LwCategoryDesignationTable extends Component
{
    use PaginateTrait;
    ...
    {
        return view('livewire.coupon.lw-category-designation-table');
    }
    ...
    public function lwPgListToCollection($perPage = 10)
    {
        ...
        if ($this->pgLoadData) {
            ...
            if ($couponPlan->isNotEmpty) {
                $list = $couponPlan->couponPlanTargetClass()
                    ->with([
                    ...
                    ->whereHas('departmentClassificationDepartmentClassificationCode')
                    ->whereHas('departmentClassificationMiddleClassificationCode')
                    ->whereHas('departmentClassificationSubClassificationCode')
